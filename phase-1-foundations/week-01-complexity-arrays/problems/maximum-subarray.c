 ...
 *Kadane's algorithm: walk the array once keeping a running sum. At each step either
 *extend the current subarray or start fresh at the current element, and track the best.
 *
 *Only 1 loop through the array -> O(n)
 */
